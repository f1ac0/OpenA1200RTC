...
Rev "2.0"
Comp "FLACO"
Comment1 "schematic and layout are Open Hardware like its source"
Comment2 "and adapted to a smaller form factor"
Comment3 "https://github.com/screwbreaker/OpenA1200RTC"
Comment4 "This schmatic was taken from other free project by screwbreaker:"
$EndDescr
$Comp
L OpenA1200RTC-rescue:Conn_02x11_Odd_Even-conn J1
U 1 1 5C2D0C55
P 6250 4800
F 0 "J1" V 6346 5779 50  0000 L CNN
F 1 "Connector_2x11_2mm" V 6255 5779 50  0000 L CNN
F 2 "Socket_Strips:Socket_Strip_Straight_2x11_Pitch2.00mm" H 6250 4800 50  0001 C CNN
...
$EndComp
$Comp
L OpenA1200RTC-rescue:BAT54C-Diode D1
U 1 1 5C2D1799
P 6900 1750
...
Wire Wire Line
	6500 2700 6900 2700
$Comp
L OpenA1200RTC-rescue:R-Device R5
U 1 1 5C2D1910
P 6500 1400
F 0 "R5" H 6550 1400 50  0000 L CNN
F 1 "220" V 6500 1325 50  0000 L CNN
F 2 "Resistors_SMD:R_0805" V 6430 1400 50  0001 C CNN
...
Wire Wire Line
	6500 1550 6500 1750
$Comp
L OpenA1200RTC-rescue:R-Device R4
U 1 1 5C2D1E7A
P 7300 1400
...
Wire Wire Line
	7300 1250 7300 1000
$Comp
L OpenA1200RTC-rescue:Battery_Cell-Device BT1
U 1 1 5C2D20CE
P 5750 1500
...
NoConn ~ 6500 2900
$Comp
L OpenA1200RTC-rescue:R-Device R2
U 1 1 5C2D2A46
P 4250 1400
...
$EndComp
$Comp
L OpenA1200RTC-rescue:R-Device R1
U 1 1 5C2D2B8C
P 4550 1400
...
$EndComp
$Comp
L OpenA1200RTC-rescue:R-Device R3
U 1 1 5C2D2BFC
P 4850 1400
...
F 1 "VDD" H 7067 2873 50  0000 C CNN
...
$Comp
L OpenA1200RTC-rescue:C-Device C1
U 1 1 5C2E4845
P 10150 1250
...
$EndComp
$Comp
L OpenA1200RTC-rescue:C-Device C2
U 1 1 5C2E60A0
P 10750 1250
...
F 2 "Symbols:OSHW-Logo_5.7x6mm_SilkScreen" H 10050 6250 50  0001 C CNN
...
Add optional jumper on RTC_CS to\ndisable the unit without disconnecting
Wire Wire Line
	3200 2800 4250 2800
Text Notes 9000 3750 0    50   ~ 0
Suitable chips :\nEPSON RTC62421\nEPSON RTC72421\n\nmissing external oscillator for OKI MSM6242B\nOKI MSM6242B
$Comp
L OpenA1200RTC-rescue:Conn_01x02-conn J2
U 1 1 5D37BA2F
P 5250 1500
F 0 "J2" H 5168 1175 50  0000 C CNN
F 1 "Battery" H 5168 1266 50  0000 C CNN
F 2 "Pin_Headers:Pin_Header_Straight_1x02_Pitch2.54mm" H 5250 1500 50  0001 C CNN
...
FLACO 20190722\nRemoved Jumper on RTC_CS\nAdded header for wired battery\nChanged connector to 2x11
...
40
$Comp
L OpenA1200RTC-rescue:Battery_Cell-Device BT2
U 1 1 5D39E3F8
P 6100 1500
F 0 "BT2" H 6218 1596 50  0000 L CNN
F 1 "Battery_Holder" H 6218 1505 50  0000 L CNN
F 2 "sassa:Battery_Holder_Coin_1220_BS-1220-1" V 6100 1560 50  0001 C CNN
F 3 "~" V 6100 1560 50  0001 C CNN
	1    6100 1500
	1    0    0    -1  
$EndComp
Wire Wire Line
